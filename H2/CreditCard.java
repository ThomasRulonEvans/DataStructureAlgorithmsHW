...
public class CreditCard {
  ...
  public void setAccount(String acnt) {
    //Test print before and after changing account number
    System.out.println("Changing account from: " + account + " to: " + acnt + "."); 
    account = acnt;
  ...
  public void makePayment(double amount) {            // make a payment
    //if else statement to ignores negative payments and notify user of invalid amount.
    if ( amount < 0 ){
      System.out.println("This is an invalid payment amount.");
    }
    else{
      balance -= amount;
    }
  ...
  public static void main(String[] args) {
    ...
    //Call setAccount method to change account number
    wallet[0].setAccount("0000-1111-2222-3333");
    ...
    //Test making negative payment
    wallet[1].makePayment(-100);
